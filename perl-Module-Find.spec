...
Source0  : https://cpan.metacpan.org/authors/id/C/CR/CRENZ/Module-Find-0.16.tar.gz
Summary  : 'Find and use installed modules in a (sub)category'
Group    : Development/Tools
License  : Artistic-1.0-Perl
Requires: perl-Module-Find-perl = %{version}-%{release}
...
%package perl
Summary: perl components for the perl-Module-Find package.
Group: Default
Requires: perl-Module-Find = %{version}-%{release}

%description perl
perl components for the perl-Module-Find package.


%prep
%setup -q -n Module-Find-0.16
cd %{_builddir}/Module-Find-0.16
